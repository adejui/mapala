                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        <img id="mainImage"
                            ...
                            class="w-3/4 h-3/4 object-contain mix-blend-multiply transition duration-300">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        ...
                        @forelse ($thumbnails as $photo)
                            <div onclick="changeImage(this)"
                                class="aspect-square bg-gray-100 rounded-2xl cursor-pointer hover:border-2 hover:border-[#7C3AED] border-2 border-transparent transition flex items-center justify-center">

                                <img src="{{ asset('storage/' . $photo->photo_path) }}"
                                    class="thumb w-2/3 h-2/3 object-contain opacity-70 hover:opacity-100">
