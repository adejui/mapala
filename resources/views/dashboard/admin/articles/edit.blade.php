...
@section('content')
    ...
    <x-breadcrumb :items="[['label' => 'Artikel', 'url' => route('articles.index')], ['label' => 'Edit Artikel']]" />
    ...
    <div
        ...
        <h3 class="font-bold text-2xl text-gray-800 dark:text-white/90 mb-6">Edit Artikel</h3>



        <form id="article-form" action="{{ route('articles.update', $article->id) }}" method="POST"
            ...
            <div class="grid sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <div class="mb-4">
                        <label
                            class="text-[#616161] font-medium text-xs mb-2 block text-md text-md  dark:text-gray-400">Jenis
                            Kegiatan</label>
                            ...
                            <select name="activity_id"
                                ...
                                @forelse ($activities as $activity)
                                    <option value="{{ $activity->id }}"
                                        {{ old('activity_id', $article->activity_id) == $activity->id ? 'selected' : '' }}>
                                        {{ $activity->title }}
                                    </option>
                                @empty
                                @endforelse
                    ...
                    <div class="mb-4">
                        <label
                            class="text-[#616161] font-medium text-xs mb-2 block text-md text-md  dark:text-gray-400">Status</label>
                    ...
                    <div class="mb-4">
                        <label
                            class="text-[#616161] font-medium text-xs mb-2 block text-md dark:text-gray-400">Thumbnail</label>
                        ...
                        @if ($article->file_path)
                            <img src="{{ asset('storage/' . $article->file_path) }}" class="mt-2 w-full max-h-96 rounded">
                        @else
                        @endif
                    </div>
                </div>
                ...
                <div>
                    <label
                        class="text-[#616161] font-medium text-xs mb-2 block text-md text-md dark:text-gray-400">Isi</label>

                    <div id="editor-wrapper">
                        <div id="editor" class="dark:text-gray-400"></div>
                    </div>
                </div>
