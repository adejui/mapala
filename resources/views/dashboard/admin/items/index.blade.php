...
@section('content')
    ...
    <div x-data="{
        ...
        <div
            ...
            <h3 class="font-bold text-2xl text-gray-800 dark:text-white/90 mb-0">Daftar Alat</h3>
            <p class="text-gray-700 mt-0 w-full lg:w-5/7 text-sm font-normal mb-6">Kelola Data Alat dengan Mudah dan
                Terorganisir
            </p>
            ...
            <div class="flex justify-between items-center my-2">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button @click="showForm = true"
                        class="inline-flex items-center py-2.5 gap-2 px-4 h-10 text-sm font-medium text-white bg-[#7653afaa] transition rounded-lg shadow-theme-xs hover:bg-[#68489C]">
            ...
            <div class="flex flex-wrap items-end justify-between gap-4 mt-6 w-full">
                ...
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="hs-dropdown [--auto-close:inside] relative">
                        ...
                        <div class="flex flex-col">
                            ...
                            <button id="categoryDropdownBtn" type="button"
                                class="hs-dropdown-toggle py-3 w-52 px-4 inline-flex items-center justify-between gap-x-2 text-sm font-normal rounded-lg border border-gray-300 bg-white text-gray-800 shadow-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
                        ...
                        <!-- Dropdown -->
                        <div
                            class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-60 bg-white shadow-md rounded-lg mt-2 dark:bg-gray-800 dark:border dark:border-gray-700">

                            <div class="p-1 space-y-0.5">

                                <button type="button" data-value="all"
                                    class="category-option flex items-center w-full py-2 px-3 bg-gray-100 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                                ...
                                @foreach ($categories as $category)
                                    <button type="button" data-value="{{ $category->id }}"
                                        class="category-option flex items-center w-full py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700">
                    ...
                    <button id="resetFiltersBtn"
                        class="px-4 py-3 border border-gray-300 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg text-sm font-medium flex items-center gap-2 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 transition-colors">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function updateExportUrl() {
                ...
                exportBtn.href =
                    `{{ route('items.export') }}?${params.toString()}`;
            }
