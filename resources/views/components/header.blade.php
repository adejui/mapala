    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <a href="index.html" class="lg:hidden">
                <img class="dark:hidden w-10 h-10" src="{{ asset('assets/images/logo/logo-transparent.png') }}"
                    alt="Logo" />
                <img class="hidden dark:block w-10 h-10" src="{{ asset('assets/images/logo/logo-transparent.png') }}"
                    alt="Logo" />
            </a>
            ...
            <div class="2xsm:gap-3 flex items-center gap-2">
                ...
                <div class="relative" x-data="{ dropdownOpen: false, notifying: true }" @click.outside="dropdownOpen = false">
                    <button
                        ...
                        @if ($notifLoans->count() > 0)
                            <span class="absolute top-0.5 right-0 z-1 h-2 w-2 rounded-full bg-green-400">
                                <span
                                    class="absolute -z-1 inline-flex h-full w-full animate-ping rounded-full bg-green-400 opacity-75"></span>
                            </span>
                        @endif
                                        ...
                                        <span class="block">
                                            <span class="text-theme-sm mb-1.5 block text-gray-500 dark:text-gray-400">
                                                ...
                                                <div class="text-theme-xs text-gray-500 dark:text-gray-400">
                                                    {{ \Carbon\Carbon::parse($notif->borrow_date)->translatedFormat('d F Y') }}
                                                    -
                                                    {{ \Carbon\Carbon::parse($notif->return_date)->translatedFormat('d F Y') }}
                                                </div>
                                            </span>
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <div class="flex flex-col mr-1">
                        ...
                        <span {{-- class="text-theme-xs flex items-center gap-2 text-gray-500 dark:text-gray-400">{{ auth()->user()->role }}</span> --}}
                            class="text-theme-xs flex items-center gap-2 text-gray-500 dark:text-gray-400">
