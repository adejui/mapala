...
<head>
    ...
    <title>Keterlambatan Pengembalian Alat</title>
</head>
        ...
        <tr>
            <td style="padding: 40px;">
                ...
                <p style="color: #4b5563; font-size: 16px; line-height: 24px;">
                    Kami informasikan bahwa peminjaman alat Anda dengan ID <strong>#{{ $data['id'] }}</strong>
                    telah melewati batas waktu pengembalian:
                </p>

                <div style="margin: 20px 0; text-align: center;">
                    <span
                        style="background-color: #fee2e2; color: #991b1b; padding: 12px 25px; border-radius: 50px; font-weight: bold; font-size: 16px; display: inline-block; border: 1px solid #ef4444;">
                        ⚠️ TERLAMBAT / OVERDUE
                    </span>
                </div>
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="padding-bottom: 10px; color: #6b7280; font-size: 14px;">Batas
                                        Pengembalian:
                                    </td>
                                    <td
                                        style="padding-bottom: 10px; color: #dc2626; font-weight: bold; text-align: right;">
                                        {{ $data['return_date'] }}</td>
                                </tr>
                                <tr>
                ...
                <p style="color: #4b5563; font-size: 16px; line-height: 24px;">
                    Mohon segera kembalikan seluruh alat ke sekretariat kami <strong>sesegera mungkin</strong>.
                    Keterlambatan yang berkelanjutan dapat mempengaruhi status jaminan (KTM/KTP) dan hak
                    peminjaman Anda di kemudian hari.
                </p>

                <div style="background-color: #fff; border-left: 4px solid #ef4444; padding: 15px; margin: 25px 0;">
                    <p
                        style="margin: 0; color: #6b7280; font-size: 12px; text-transform: uppercase; font-weight: bold;">
                        Lokasi Pengembalian:</p>
                ...
                <p style="color: #4b5563; font-size: 14px; margin-top: 30px;">
                    Jika ada kendala yang menyebabkan keterlambatan ini, segera hubungi Tim Logistik kami agar
                    dapat kami bantu:
                </p>
