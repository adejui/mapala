        ...
        <tr>
            <td style="padding: 40px;">
                ...
                <p style="color: #4b5563; font-size: 16px; line-height: 24px;">
                    Mohon maaf, pengajuan peminjaman alat Anda dengan ID <strong>#{{ $data['id'] }}</strong> telah
                ...
                <p style="color: #4b5563; font-size: 16px; line-height: 24px;">
                    Pengajuan Anda belum dapat kami setujui untuk saat ini. Hal ini dapat disebabkan oleh
                    ketersediaan stok, jadwal peminjaman yang bertabrakan, atau kelengkapan data pengajuan.
                </p>
                ...
                <div style="background-color: #fff; border-left: 4px solid #7C3AED; padding: 15px; margin: 25px 0;">
                    <p
                        ...
                        Ingin Mengajukan Ulang?</p>
                    <p style="margin: 5px 0 15px 0; color: #4b5563; font-size: 14px;">
                        Anda dapat mengajukan kembali peminjaman dengan menyesuaikan tanggal atau jumlah alat yang
                        dibutuhkan.
                    </p>
                ...
                <p style="color: #4b5563; font-size: 14px; margin-top: 30px;">
                    Jika Anda merasa ini adalah suatu kekeliruan atau butuh penjelasan lebih lanjut, silakan hubungi
                    Tim Logistik kami:
                </p>
