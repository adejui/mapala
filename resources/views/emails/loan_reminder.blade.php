...
<head>
    ...
    <title>Pengingat Pengembalian Alat</title>
</head>
        ...
        <tr>
            <td style="padding: 40px;">
                ...
                <p style="color: #4b5563; font-size: 16px; line-height: 24px;">
                    Ini pengingat untuk peminjaman alat Anda dengan ID <strong>#{{ $data['id'] }}</strong>.
                    Batas waktu pengembalian tinggal <strong>1 hari lagi</strong>:
                </p>

                <div style="margin: 20px 0; text-align: center;">
                    <span
                        style="background-color: #fef3c7; color: #92400e; padding: 12px 25px; border-radius: 50px; font-weight: bold; font-size: 16px; display: inline-block; border: 1px solid #f59e0b;">
                        ⏰ JATUH TEMPO BESOK
                    </span>
                </div>
                        ...
                        <td style="padding: 20px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="padding-bottom: 10px; color: #d97706; font-weight: bold; text-align: right;">
                                        {{ $data['return_date'] }}</td>
                                </tr>
                                <tr>
                ...
                <p style="color: #4b5563; font-size: 16px; line-height: 24px;">
                    Mohon segera kembalikan seluruh alat ke sekretariat sebelum atau tepat pada tanggal di atas
                    untuk menghindari status keterlambatan pada akun peminjaman Anda.
                </p>
                ...
                <p style="color: #4b5563; font-size: 14px; margin-top: 30px;">
                    Jika Anda membutuhkan perpanjangan waktu peminjaman, segera hubungi Tim Logistik kami
                    sebelum jatuh tempo:
                </p>
